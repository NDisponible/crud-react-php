...
function App() {
  ...
  const peticionPost= async()=>{
    ...
    await axios.post(baseUrl, f).then(response=>{setData(data.concat(response.data));
  ...
  const peticionDelete= async()=>{
    ...
    .then(response=>{setData(data.filter(framework=>framework.id!==frameworkSeleccionado.id));
...
const seleccionarFramework=(framework, caso)=>{
  ...
  return (
    ...
    <br/>
    <button className="btn btn-success" onClick={()=>abrirCerrarModalInsertar()}>Insertar Framework</button>
    <br/> <br/>
    <table className="table table-dark table-responsive-sm table-responsive-md">
      <thead>
        <tr>
          <th className='table-primary'>Id</th>
          <th className='table-primary'>Nombre</th>
          <th className='table-primary'>Lanzamiento</th>
          <th className='table-primary'>Desarrollador</th>
